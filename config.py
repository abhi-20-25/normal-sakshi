...
APP_TASKS_CONFIG = {
    'Generic': {
        'model_path': 'models/kitchen_compliance_02_02_2026.pt',
        'target_class_id': [0, 1, 2, 3, 4, 5, 6, 7, 8],  # kitchen_compliance_02_02_2026: Uniform(0), Without_uniform(1), Cap_present(2), Without_cap(3), With_apron(4), Without_apron(5), With_gloves(6), Without_gloves(7), Using_phone(8)
        'confidence': 0.3,
        'is_gif': False
    },
    'PeopleCounter': {
